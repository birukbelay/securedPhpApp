      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Add Technecians page</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="logged-page.php">controll page <i class="ion-ios-arrow-forward"></i></a></span> <span>add <i class="ion-ios-arrow-forward"></i></span>
             <span>add technecians <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
    	...
    	<div class="container">
    		...
    		<div class="col-md-6 py-5 pr-md-5">
	          <div class="heading-section heading-section-white ftco-animate mb-5">
	            ...
	            <h2 class="mb-4">Add technecians
                  </h2>
	            <p>you can add technecians by filling the form below</p>
	          </div>


	          <form action="php/register/register_technician.php" method="post" enctype="multipart/form-data" class="appointment-form ftco-animate">
	    				<div class="d-md-flex">
	    				...
	    				<div class="d-md-flex">
	    					...
	    					<div class="form-group ml-md-4">
		    					<input type="tect" name="field" class="form-control" placeholder="field of technecian" required>
		    				</div>
	    			<div class="form-group ml-md-4">
	    				...
	    				<div class="d-md-flex">
	    					...
	    					<div class="form-group">
		              <textarea  name="description" id="" cols="30" rows="2" class="form-control" placeholder="descreption"></textarea>
		            </div>
	    				</div>
